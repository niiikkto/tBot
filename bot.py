...
def handle_query(message, query_type):
    try:
        ...
        if query_type == 'Поиск фильмов':
            prompt = f"Рекомендуй фильм по следующим ключевым словам: {message.text} сделай формат текста без символов, название и короткое описание, несколько фильмов. Только фильмы, если вопрос не связан с фильмами не отвечай"
        elif query_type == 'Поиск игр':
            prompt = f"Рекомендуй игру по следующим ключевым словам: {message.text} сделай формат текста без символов, название и короткое описание, несколько игр. Только игры, если вопрос не связан с играми не отвечай"
        elif query_type == 'Поиск книг':
            prompt = f"Рекомендуй книгу по следующим ключевым словам: {message.text}  сделай формат текста без символов, название и короткое описание, несколько книг. Только книгами, если вопрос не связан с книгами не отвечай"
        else:
            prompt = message.text
